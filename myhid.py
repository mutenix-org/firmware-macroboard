...
MACROBOARD_DESCRIPTOR = bytes((
    ...
    0x95, IN_REPORT_LENGTH,  # ReportCount(8) 1st: message type, 2nd-6th: message
    ...
    0x15, 0x00,  # LogicalMinimum(0)
    0x26, 0xFF, 0x00,  # LogicalMaximum(255)
    0x95, OUT_REPORT_LENGTH,  # ReportCount(8)
...
stupid_macroboard = usb_hid.Device(
    ...
    in_report_lengths=(IN_REPORT_LENGTH,),    # This device sends 1 byte in its report.
    out_report_lengths=(OUT_REPORT_LENGTH,),   # It does not receive any reports.
)
